...
public class CodeRotation extends Activity {
    ...
    private void setUI(){
        ...
        textViewToChange.setText(this.getResources().getString(R.string.code_rotation));

        textViewToChange = (TextView) findViewById(R.id.first_text_block);
        textViewToChange.setText(this.getResources().getString(R.string.code_rotation_paragraph));
